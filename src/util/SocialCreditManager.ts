...
export module SocialCreditManager {
    ...
    export async function setSocialCreditFromMessage(message: Message, reasons: Array<string>, socialCredit: number, reply: boolean = true) {
    ...
    export async function addSocialCreditFromMessage(message: Message, reasons: Array<string>, socialCredit: number, reply: boolean = true) {
        const userID = message.author.id;
        const currentSocialCredit = await getSocialCredit(userID);
        await setSocialCredit(userID, currentSocialCredit + socialCredit);
        if (reply) {
