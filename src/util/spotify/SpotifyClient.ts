...
export default class SpotifyClient {
	...
	public IsTokenExpired(): boolean {
		...
		return this.accessToken.created_at.getTime() + this.accessToken.expires_in * 1000 < new Date().getTime();
	}

	public async search(q: string, type: Array<string>, options?: { include_external?: string, limit?: number, market?: string, offset?: number }): Promise<SpotifySearchResult> {
